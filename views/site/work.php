                    ...
                    <? if ($bloggers_waiting_creatives_db) { ?>
                        ...
                        <?php foreach ($bloggers_waiting_creatives_db as $bloggers_waiting_creatives) { ?>
                            ...
                            <tr class="funner_table_body">
                                ...
                                <!-- CPM -->
                                <td class="funner_table_td_common funner_table_td_cpm collapsed collapsed_cursor work_funner_td_close_right" data-toggle="collapse" data-target="#collapse<?=$bloggers_waiting_creatives->id ?>" aria-expanded="false" aria-controls="collapse<?=$bloggers_waiting_creatives->id ?>">
                    ...
                    <? if ($bloggers_agreed_creative_db) { ?>
                        ...
                        <?php foreach ($bloggers_agreed_creative_db as $bloggers_agreed_creative) { ?>
                            ...
                            <tr class="funner_table_body">
                                ...
                                <!-- CPM -->
                                <td class="funner_table_td_common funner_table_td_cpm collapsed collapsed_cursor work_funner_td_close_right" data-toggle="collapse" data-target="#collapse<?=$bloggers_agreed_creative->id ?>" aria-expanded="false" aria-controls="collapse<?=$bloggers_agreed_creative->id ?>">
                                                    ...
                                                    <div class="work_creatives_skin">
                                                        ...
                                                        <div class="d-flex mr-3 work_creative_left">
                                                            ...
                                                            <?php
                                                                ...
                                                                {
                                                                    echo '<img src="'.$creative->media_link.'" alt="">';
                                                                }
                                                        ...
                                                        <div class="work_creative_right">
                                                            ...
                                                            <div class="work_coment_main">
                                                                                        ...
                                                                                        <div class="popup_com_meta">
                                                                                            <span>
                                                                                                <?php
                                                                                                    ...
                                                                                                    foreach ($data_platforms as $data_platform)
                                                                                                    {
                                                                                                        echo '<span class="popup_com_blogger_account">'.$data_platform->account.'</span>';
                                                                                                    }
                                                                                                ?>
                                                                                            </span>
                                                                                        </div>
                                                                ...
                                                                <? } else { ?>
                                                                    <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" placeholder="Напишите комментарий" name="comment_creative_<?=$creative->id ?>"></textarea>
                                                                <? } ?>
                                                            </div>
                                                        </div> <!-- end work_creative_right -->
                    ...
                    <? if ($bloggers_pending_publication_db) { ?>
                        ...
                        <?php foreach ($bloggers_pending_publication_db as $bloggers_pending_publication) { ?>
                            ...
                            <tr class="funner_table_body">
                                ...
                                <!-- CPM -->
                                <td class="funner_table_td_common funner_table_td_cpm collapsed collapsed_cursor work_funner_td_close_right" data-toggle="collapse" data-target="#collapse<?=$bloggers_pending_publication->id ?>" aria-expanded="false" aria-controls="collapse<?=$bloggers_pending_publication->id ?>">
