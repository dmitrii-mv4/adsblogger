...
<!-- ========== Loading Page ========== -->
    <div class="preloader">
        ...
        <span class="loading-text text-uppercase">Загрузка ...</span>
            ...
            <div class="inner-header p-relative">
                <div class="main-logo">
                    <a href="index.html" data-dsn="parallax">
                    	<img class="light-logo" src="web/images/logo.png">
                    </a>
                </div>
            </div>
        </div>
            ...
            <div class="side-box-right text-stroke border-right text-uppercase z-index-2">
                <div class="text-inner over-hidden">
                    <div class="text-stroke-box">
                        <div class="text-stroke-inner">ADSBLOGGER</div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div id="dsn-scrollbar">
            <div class="inner-content">
                ...
                <header class="p-relative h-v-100 dsn-header-animation p-relative">
                    ...
                    <div class="box-content dsn-container align-items-center ">
                        <div class="hero-content dsn-hero-parallax-title">
                            ...
                            <p class="description mt-20 max-w570">Креативное Influencer Marketing агентство <br/>
                                Повышаем окупаемость рекламы у блогеров с помощью собственного IT-инструмента.
                            </p>
                            	<a href="#" class="link-custom v-light image-zoom mt-30" target="_blank" rel="nofollow noopener" data-dsn="parallax">Стратегия продвижения</a>
                            	<br/><br/>
                            	БЕСПЛАТНО
                            	<br/><br/>
                            	---------------------------
	                            ...
	                            <br/><br/>
	                            Собственная IT - разработка  ADSBLOGGER позволяет прогнозировать эффективность публикаций еще до старта кампании.
	                            <br/><br/>
	                            Все в одном месте - и точка.
	                            <br/><br/>
	                            1. Прогнозируй эффективность! <br/>
								2. Контролируй размещения публикаций <br/>
								3. Согласовывай креативы <br/>
								4. Получай отчетность <br/>
								5. Масштабируйся <br/>
								6. Закрывающие документы в два клика! <br/>
                            </p>
                        </div>
                ...
                <div class="wrapper">
                    ...
                    <section  class="pages-view section-padding p-relative v-light" data-dsn-title="Demos">
                        <div class="dsn-container d-flex flex-column">

                            <p class="sub-heading mb-15">
                                <span class="background-section pt-5 pb-5 pl-15 pr-15">START WITH A DEMO</span>

                            </p>
                            <h2 class="section-title">ДЕРЖИ РУКУ НА ПУЛЬСЕ
                                <br> СОБСТВЕННАЯ IT РАЗРАБОТКА
                            </h2>
                                ...
                                <div class="box-view-item">
                                    <div class="box-img">
                                        <a href="demo.html" target="_blank">
                                            <img src="assets/img/view/demo.jpg" alt="">
                                        </a>
                                    ...
                                    <div
                                        ...
                                        <h4
                                            ...
                                            <a href="demo.html" target="_blank"> <span
                                                    class="background-theme p-5">01</span> - Прогнозируй эффективность!</a>
                                        </h4>
                                    </div>
                                ...
                                <div class="box-view-item">
                                    <div class="box-img">
                                        <a href="demo-2.html" target="_blank">
                                            <img src="assets/img/view/demo-2.jpg" alt="">
                                        </a>
                                    ...
                                    <div
                                        ...
                                        <h4
                                            class="sm-title-block background-section text-uppercase  pt-10 pb-10 pl-15 pr-15 line-bg-right">
                                            <a href="demo-2.html" target="_blank"> <span
                                                    class="background-theme p-5">02</span> - Контролируй размещения публикаций
</a>
                                        </h4>
                                    </div>
                                ...
                                <div class="box-view-item">
                                    <div class="box-img">
                                        <a href="demo-3.html" target="_blank">
                                            <img src="assets/img/view/demo-3.jpg" alt="">
                                        </a>
                                    ...
                                    <div
                                        ...
                                        <h4
                                            class="sm-title-block background-section text-uppercase  pt-10 pb-10 pl-15 pr-15 line-bg-right">
                                            <a href="demo-3.html" target="_blank"> <span
                                                    class="background-theme p-5">03</span> - Согласовывай креативы</a>
                                        </h4>
                                    </div>
                                ...
                                <div class="box-view-item">
                                    <div class="box-img">
                                        <a href="personal.html" target="_blank">
                                            <img src="assets/img/view/demo-4.jpg" alt="">
                                        </a>
                                    ...
                                    <div
                                        ...
                                        <h4
                                            class="sm-title-block background-section text-uppercase  pt-10 pb-10 pl-15 pr-15 line-bg-right">
                                            <a href="personal.html" target="_blank"> <span
                                                    class="background-theme p-5">04</span> - Получай отчетность</a>
                                        </h4>
                                    </div>
                                ...
                                <div class="box-view-item">
                                    <div class="box-img">
                                        <a href="slider-webgel-horizontal.html" target="_blank">
                                            <img src="assets/img/view/demo-5.jpg" alt="">
                                        </a>

                                    </div>
                                    <div class="box-title p-relative mt-30 d-flex align-items-center">
                                        <h4 class="sm-title-block text-uppercase ">
                                            <a href="slider-webgel-horizontal.html" target="_blank"> <span
                                                    class="background-theme p-5">05</span> - Масштабируйся</a>
                                        </h4>
                                    </div>
                                ...
                                <div class="box-view-item">
                                    <div class="box-img">
                                        <a href="slider-webgel-horizontal-2.html" target="_blank">
                                            <img src="assets/img/view/demo-6.jpg" alt="">
                                        </a>

                                    </div>
                                    <div class="box-title p-relative mt-30 d-flex align-items-center">
                                        <h4 class="sm-title-block text-uppercase ">
                                            <a href="slider-webgel-horizontal-2.html" target="_blank"> <span
                                                    class="background-theme p-5">06</span> - Закрывающие документы в два клика!</a>
                                        </h4>
                                    </div>
                    ...
                    <section class="pages-view section-padding p-relative v-light background-section"
                        ...
                        <div class="dsn-container d-flex flex-column">
                            ...
                            <h2 class="section-title ">КАКИЕ ЗАДАЧИ РЕШАЕМ
<!--                                 <br> PERFECT LAYOUTS -->
                            </h2>
                    ...
                    <section class="features section-padding p-relative" data-dsn-title="features">
                        <div class="dsn-container d-flex flex-column">
                            ...
                            <h2 class="section-title">Встраиваем influencer marketing в вашу <br/> коммуникационную стратегию</h2>
                        </div>
		...
		l53.02,53.013c5.238,5.245,5.238,13.75,0,18.995C111.644,455.252,108.203,456.559,104.769,456.559z" />
                                ...
                                <li
                                    ...
                                    <h5 class="sm-title-block mt-15">Разрабатываем подачу</h5>
                                </li>
			...
			L338.213,256L482,112.212V399.787z" />
                                    ...
                                    <h5 class="sm-title-block mt-15">Продвинутый таргетинг</h5>
                                </li>
                ...
                <footer class="footer border-top background-section">
                    <div class="dsn-container">
                        ...
                        <div class="footer-bottom d-grid grid-md-2 border-top pt-30 mt-30">
                            ...
                            <div class="footer-item">
                                <div class="copyright">
                                    <div class="copright-text over-hidden">© 2020 ООО ADSBLOGGER
                                    </div>
                                </div>
                            </div>
                        </div>
