    ...
    <?php $this->beginBody() ?>
       ...
       <div class="topbar">
             ...
             <nav class="navbar-custom">
                ...
                <a href="/klient"><img src="/web/images/logo.png" alt="logo" class="logo-klient"></a>
                ...
                <ul class="list-unstyled topbar-nav float-right mb-0 flex">
                    ...
                    <li class="dropdown dropdown-log">
                        <a class="nav-link dropdown-toggle waves-effect waves-light nav-user" data-toggle="dropdown" href="#" role="button"
                            ...
                            <?php } else { ?>
                                <img src="/web/images/users/user-1.jpg" alt="Нет изображения" class="rounded-circle">
                            <? } ?>
