...
?>
<div class="user-form-index manager_form">

    <h1><?= Html::encode($this->title) ?></h1>

    <p>
        <?= Html::a(Yii::t('app', 'Создать нового пользователя'), ['create'], ['class' => 'btn btn-primary']) ?>
    </p>
            ...
            <?php foreach ($model as $value) { ?>
                ...
                <?php
                    ...
                    switch ($value->role) {
                        ...
                        default:
                            $value->role = 'Роль пользователя не определена';
                            break;
                    }
                ?>
                ...
                <tr data-key="1">
                    ...
                    <td><a href="/user/view/<?=$value->id ?>" title="Просмотр" aria-label="Просмотр" data-pjax="0">
                        ...
                        <a href="/user/update/<?=$value->id ?>" title="Редактировать" aria-label="Редактировать" data-pjax="0">
